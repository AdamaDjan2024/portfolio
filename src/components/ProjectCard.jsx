    ...
    >
      ...
      <div className="z-10 mt-1 sm:col-span-4">
        {hasImage ? (
          ...
          <div className="aspect-video w-full rounded border-2 border-slate-200/10 bg-slate-800/50 text-[0.65rem] uppercase tracking-widest text-slate flex items-center justify-center">
            Aperçu indisponible
          </div>
        )}
      </div>
